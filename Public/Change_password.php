...
if(!isset($_SESSION['user'])){
    header("Location: ../Apps/Controller/login_control.php");
    exit();
}
            ...
            <div class="container">
                <div class="p-4 d-flex justify-content-center">
                    <div class="card w-50 p-4">
                        <h3 class="font-weight-bold m-4 text-primary text-center">ĐỔI MẬT KHẨU</h3>
                        <form action="../Apps/Controller/change_pass_control.php" method="post">
                            <div class="form-row pl-4 pr-4">
                                <div class="col-md-12 mb-3">
                                    <label for="old_pass">Mật khẩu cũ:<sup class="text-danger">*</sup></label>
                                    <input type="password" name="old_pass"
                                           class="form-control<?= isset($_SESSION['mess_old_pass'])? ' is-invalid':''?>"
                                           id="old_pass" placeholder="Mật khẩu cũ">
                                    <div class="invalid-feedback">
                                        <?= isset($_SESSION['mess_old_pass'])? $_SESSION['mess_old_pass']:''?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row pl-4 pr-4">
                                <div class="col-md-12 mb-3">
                                    <label for="new_pass">Mật khẩu mới:<sup class="text-danger">*</sup></label>
                                    <input type="password" name="new_pass"
                                           class="form-control<?= isset($_SESSION['mess_new_pass'])? ' is-invalid':''?>"
                                           id="new_pass" placeholder="Mật khẩu mới">
                                    <div class="invalid-feedback">
                                        <?= isset($_SESSION['mess_new_pass'])? $_SESSION['mess_new_pass']:''?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row pl-4 pr-4">
                                <div class="col-md-12 mb-3">
                                    <label for="re_new_pass">Nhập lại mật khẩu mới:<sup class="text-danger">*</sup></label>
                                    <input type="password" name="re_new_pass"
                                           class="form-control<?= isset($_SESSION['mess_re_new_pass'])? ' is-invalid':''?>"
                                           id="re_new_pass" placeholder="Mật khẩu mới">
                                    <div class="invalid-feedback">
                                        <?= isset($_SESSION['mess_re_new_pass'])? $_SESSION['mess_re_new_pass']:''?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row m-4">
                                <div class="col-md-12 mb-3 d-flex justify-content-around">
                                    <a href="Account.php" role="button" class="btn btn-danger">
