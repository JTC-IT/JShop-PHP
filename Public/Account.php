            ...
            <div class="container">
                <div class="p-4 d-flex justify-content-center">
                    <div class="card w-75 p-4">
                        <h3 class="font-weight-bold m-4 text-primary text-center">THÔNG TIN TÀI KHOẢN</h3>
                        <form action="../Apps/Controller/update_account_control.php" method="post">
                            <div class="form-row pl-4 pr-4">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="name"
                                           ...
                                           value="<?=$user['Name']?>"
                                           <?php if(!isset($_GET['mes']) || $_GET['mes'] != 1) echo 'readonly'?>
                                           required>
                            ...
                            <div class="form-row m-4">
                                <div class="col-md-12 mb-3 d-flex justify-content-around">
                                    <?php if(!isset($_GET['mes']) || $_GET['mes'] != 1){ ?>
                                        <a href="../Apps/Controller/change_pass_control.php" role="button" class="btn btn-warning">
                                            <ion-icon name="sync-outline"></ion-icon>
                                            Đổi mật khẩu
                                        </a>
                                        <a href="Account.php?mes=1" role="button" class="btn btn-primary">
...
if(isset($_GET['mes'])){
    if($_GET['mes'] == 2)
        echo "<script>alert('Đã cập nhật tài khoản!')</script>";
    if($_GET['mes'] == 3)
