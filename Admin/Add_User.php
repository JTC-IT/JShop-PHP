...
<div class="container min-vh-100">
    <fieldset class="container w-100 h-100 d-flex justify-content-center">
        <form action="../Apps/Controller/add_user_control.php" method="post" class="w-50 rounded mt-4 p-4"
            ...
            <!-- Form Name -->
            <h4 class="font-weight-bold text-center border-bottom border-dark">THÊM TÀI KHOẢN</h4>
            ...
            <div class="form-row pl-4 pr-4 mt-4">
                <div class="col-12 d-flex justify-content-end">
                    ...
                    <button type="submit" name="submit" class="btn btn-success" value="ok">Thêm</button>
                </div>
            </div>
        </form>
    </fieldset>
